...
issue](https://github.com/cisagov/ansible-role-cdm-tanium-client/issues)
...
request](https://github.com/cisagov/ansible-role-cdm-tanium-client/pulls),
...
```console
cd ansible-role-cdm-tanium-client
pyenv virtualenv <python_version_to_use> ansible-role-cdm-tanium-client
pyenv local ansible-role-cdm-tanium-client
